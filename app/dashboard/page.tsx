...
export default function DashboardPage() {
  const [wills, setWills] = useState<WillView[]>([
    { index: 1, heirs: ['0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12', '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890ab'], shares: [60, 40], executed: false },
    { index: 2, heirs: ['0x0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba09'], shares: [100], executed: true },
  ]);
  const [isLoading] = useState(false);
  const [revokingWill] = useState<number | null>(null);
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" disabled={true} title="Refresh is disabled in demo mode" size="sm">
                  ...
                  {!will.executed && (
                      <div className="flex gap-2 pt-4 border-t">
                        <Button
                            ...
                            size="sm"
                            disabled={true}
                            title="Revoke is disabled in demo mode"
                        >
